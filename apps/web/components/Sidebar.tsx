...
const NAV: NavItem[] = [
  ...
  { group: 'Pajak', href: '/pajak/rekonsiliasi-fiskal', label: 'Kelola Rekon. Fiskal', icon: 'sliders', roles: FULL },
  ...
  { group: 'Laporan', href: '/laporan/rekonsiliasi-fiskal', label: 'Rekonsiliasi Fiskal', icon: 'receipt', roles: ACCOUNTING },
  ...
  { group: 'Master Data', href: '/master/jenis-projek', label: 'Jenis Projek', icon: 'folder', roles: FULL },
